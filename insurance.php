<?php 
	...
	if(isset($_POST['submit'])){
		...
		$result = mysqli_query($connection, "INSERT INTO insurance_claim (uid,policy_id,agency) VALUES ($uid,$p_no,'$a_name')" );
	}
?>
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="insurance.php">Insurance <span class="sr-only">(current)</span></a>
...
<br>
	...
	<div class="container">
		...
		<div>
			...
			<input class="form-control" type="number" name="p_no" id="c_no" placeholder="Enter the policy number" />
		</div>
		<br>
		<div>
			<label>Agency</label>
			<input class="form-control" type="text" name="a_name" id="c_no" placeholder="Enter the Agency name" />
			</div>
			<br>
